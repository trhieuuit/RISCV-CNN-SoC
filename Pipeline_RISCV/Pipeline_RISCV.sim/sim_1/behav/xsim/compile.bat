...
REM
REM Generated by Vivado on Sun Mar 15 23:53:44 +0700 2026
...
echo "xvlog --incr --relax -prj tb_riscv_1_vlog.prj"
call xvlog  --incr --relax -prj tb_riscv_1_vlog.prj -log xvlog.log
