...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=13,da_board_cnt=4,da_bram_cntlr_cnt=1,da_clkrst_cnt=9,da_zynq_ultra_ps_e_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   ();
  ...
  wire [31:0]riscv_wrapper_0_dmem_addr_o;
  wire riscv_wrapper_0_dmem_en_o;
  wire [31:0]riscv_wrapper_0_dmem_wdata_o;
  wire [3:0]riscv_wrapper_0_dmem_we_o;
  wire [31:0]riscv_wrapper_0_imem_addr_o;
  wire riscv_wrapper_0_imem_en_o;
  wire riscv_wrapper_0_rv_done_o;
  ...
  design_1_axi_gpio_0_0 axi_gpio_0
       (.gpio2_io_i(riscv_wrapper_0_rv_done_o),
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(riscv_wrapper_0_imem_addr_o),
        ...
        .enb(riscv_wrapper_0_imem_en_o),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(1'b0),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web({1'b0,1'b0,1'b0,1'b0}));
  design_1_blk_mem_gen_1_0 blk_mem_gen_1
       (.addra(riscv_wrapper_0_dmem_addr_o),
        ...
        .dina(riscv_wrapper_0_dmem_wdata_o),
        .dinb(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .douta(blk_mem_gen_1_douta),
        .doutb(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .ena(riscv_wrapper_0_dmem_en_o),
        .enb(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .rsta(1'b0),
        .rstb(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .wea(riscv_wrapper_0_dmem_we_o),
        .web(axi_bram_ctrl_1_BRAM_PORTA_WE));
  design_1_riscv_wrapper_0_0 riscv_wrapper_0
       (.clk_i(zynq_ultra_ps_e_0_pl_clk0),
        .dmem_addr_o(riscv_wrapper_0_dmem_addr_o),
        .dmem_en_o(riscv_wrapper_0_dmem_en_o),
        .dmem_rdata_i(blk_mem_gen_1_douta),
        .dmem_wdata_o(riscv_wrapper_0_dmem_wdata_o),
        .dmem_we_o(riscv_wrapper_0_dmem_we_o),
        .imem_addr_o(riscv_wrapper_0_imem_addr_o),
        .imem_en_o(riscv_wrapper_0_imem_en_o),
        .imem_rdata_i(blk_mem_gen_0_doutb),
        .rst_ni(rst_ps8_0_99M_peripheral_aresetn),
        .rv_done_o(riscv_wrapper_0_rv_done_o),
        .rv_start_i(axi_gpio_0_gpio_io_o));
