...
module cpu_pipeline(
    ...
    output wire        inst_en_o,    // Chân kích hoạt BRAM (cắm vào chân ENA của BRAM)
    input  wire [31:0] instruction, 
    
    // Cổng DMEM (Tầng MEM)
    output wire [31:0] data_addr_o,    
    output wire [31:0] data_wdata_o,   
    output wire        data_en_o,    // Chân kích hoạt BRAM (cắm vào chân ENB)
    output wire [3:0]  data_we_o,    // Chân cho phép Ghi (cắm vào chân WEA 4-bit)
    
    input  wire [31:0] data_rdata_i    
);

    // ===========================================================================
    // KHAI BÁO DÂY DẪN (WIRES) THEO TỪNG TẦNG PIPELINE
    // ===========================================================================
    ...
    assign id_instr = (flush_if_id) ? 32'h00000013 : instruction;
